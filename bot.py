...
# ফিচার: AI চ্যাট (কাস্টম API), ফোর্স চ্যানেল জয়েন, দৈনিক রিকোয়েস্ট লিমিট,
...
# ========================= বেসিক সেটআপ =========================
BOT_TOKEN = "8242587129:AAFWaahFgxPhn7hbJnlGxIzDb95vDIisl_Y"          # <-- @BotFather থেকে পাওয়া টোকেন এখানে দিন
